...
func (k *Kernel) StartMaintainer(ctx context.Context, cwd string, opts MaintainerOptions) <-chan MaintainerResult {
...
func (k *Kernel) RunMaintainer(ctx context.Context, cwd string, opts MaintainerOptions) (MaintainerReport, error) {
	k.mu.Lock()
