...
func (k *Engine) ReplayComposedShell(ctx context.Context, sessionID, cwd, script string) (RunResult, bool) {
...
func (k *Engine) evalComposedShellNode(ctx context.Context, sessionID, cwd string, plan shellPlan, idx int, input []byte) (shellEvalResult, bool) {
