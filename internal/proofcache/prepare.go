...
func (k *Engine) Warm(ctx context.Context, cwd string) (WarmReport, error) {
	return k.warm(ctx, cwd, false)
}

func (k *Engine) WarmMetadata(ctx context.Context, cwd string) (WarmReport, error) {
	return k.warm(ctx, cwd, true)
}

func (k *Engine) warm(ctx context.Context, cwd string, metadataOnly bool) (WarmReport, error) {
	if k.Oracle == nil {
...
func (k *Engine) finishWarm(ledger *ValidityLedger, phases *PhaseTimings) error {
...
func (k *Engine) prewarmProofGatedOutputs(ctx context.Context, cwd string, ws WorldState, ledger *ValidityLedger, phases *PhaseTimings) (int, []WarmPreparedReport) {
