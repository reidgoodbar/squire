...
func runBenchCommand(ctx context.Context, k *Engine, repo string, argv []string, runs int, cmp compareMode, samples *benchSamples) CommandMetrics {
...
func runDeepIncremental(ctx context.Context, k *Engine, repo string, opts DeepBenchOptions, metadataCommands, validationCommands [][]string, samples *benchSamples) IncrementalBenchMetrics {
