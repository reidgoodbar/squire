...
func (k *Kernel) PrewarmAdjacent(ctx context.Context, cwd, sessionID string, argv []string) (int, error) {
	if k.Store == nil {
		return 0, nil
	}
	if k.Oracle == nil {
...
func (k *Kernel) prewarmProofGatedCandidate(ctx context.Context, cwd, sessionID string, argv []string, ws WorldState, ledger *ValidityLedger, phases *PhaseTimings, note string) bool {
